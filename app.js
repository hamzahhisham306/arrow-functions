...
console.log('newSum',newSum(1,2,3,4));
...
console.log('object Arrow',objectArrow());
...
const sumArrow=(a,b)=>[a+b, a*b];

// Refactor
console.log('sumArrow',sumArrow(3,9))
...
console.log('MessageArrow',messageArrow('Allie'))
...
//  it is return array of object 
// this => pointer for instance

// 2. What is "this" when joe.scopeArrow() is invoked?
//  this keyword always represents the object that defined the arrow function.
// it is return window object 

// 3. Explain why "this" is different when an arrow function is used.
// in standard function expressions  the this keyword is bound to different values based on the context in which the function is called. 
// arrow functions use the value of this in their lexical scope. This leads to very different behaviour.
